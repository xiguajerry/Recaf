...
public class Parse {
    ...
    /**
     * @param lineNo Line the token appears on.
     * @param token  First token on line.
     * @return Parser associated with the token.
     * @throws ASTParseException When the token is not valid.
     */
    ...
    /**
     * @param type Instruction type, see {@link AbstractInsnNode#getType()}.
