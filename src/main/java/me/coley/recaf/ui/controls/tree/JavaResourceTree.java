...
public class JavaResourceTree extends BorderPane {
    ...
    private final TreeView<JavaResource> tree;

    /**
     * @param controller Controller to act on.
     * @param resource   Resource to model.
     */
    ...
    private void onClick(MouseEvent e) {
        TreeItem<JavaResource> item = tree.getSelectionModel().getSelectedItem();
        if (item == null)
            return;
        // Right click
     ...
     *
     * @param item Item representing value.
     */
     ...
     *
     * @param item Item to recursively open.
     */
